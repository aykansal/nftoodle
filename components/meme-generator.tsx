...
// import { MemeGeneratorProps } from "@/lib/types";
// import { squidGameVariants, tabVariants } from "@/lib/data";
...
//     const imageDataUrl: Base64URLString = canvas.toDataURL("image/png");

//     try {
//       const { status } = await axios.post("/api/upload", { imageDataUrl });
//       console.log(
//         status === 200
//           ? "Image uploaded successfully"
//           : `Upload failed with status ${status}`
...
//       value={topText}
//       onChange={(e) => setTopText(e.target.value)}
//       className="bg-black p-2 w-full text-white placeholder:text-white/50"
//     />
//     <Input
//       type="text"
//       value={bottomText}
...
//       {tab === "templates" && <ImagePlus />}
//       {tab === "text" && <Type />}
//       {tab === "effects" && <Wand2 />}
//       {tab === "background" && <Palette />}
//       {tab.charAt(0).toUpperCase() + tab.slice(1)}
//     </TabsTrigger>
//   </motion.div>
// );
...
// }) => (
//   <>
//     {/* Text Color and Effect controls */}
//     <div className="space-y-4">
...
//   imageFilter: string;
// }) => (
//   <Select value={imageFilter} onValueChange={(value) => setImageFilter(value)}>
//     <SelectTrigger>
//       <SelectValue placeholder="Select Filter" />
//     </SelectTrigger>
//     <SelectContent>
