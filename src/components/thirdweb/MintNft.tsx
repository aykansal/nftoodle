...
import type { MintNftData } from "@/lib/types";
import { CLIENT_ID, CONTRACT_ADDRESS } from "@/lib/thirdweb";
...
export default function MintNft({
  ...
  async function mint() {
    ...
    try {
      ...
      const { payload, signature } = await axios
        .post(`${import.meta.env.VITE_BACKEND_URL}/api/mint-nft`, {
          wallet,
          name,
          description,
          image,
